...
#define REGS_DMA(channel) ((dma_channel_regs *)(BASE_ADDR + 0x00007000 + (channel * 0x100)))

#define REGS_DMA_INT_STATUS *((volatile u32 *)(BASE_ADDR + 0x00007FE0))
#define REGS_DMA_ENABLE *((volatile u32 *)(BASE_ADDR + 0x00007FF0))
