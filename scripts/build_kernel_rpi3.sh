...
aarch64-linux-gnu-gcc -c src/kernel/boot.S -o build/kernel/boot.o -D__TARGET_RPI3__
aarch64-linux-gnu-gcc -c src/kernel/lib.S -o build/kernel/liba.o -D__TARGET_RPI3__
aarch64-linux-gnu-gcc -c src/kernel/handler.S -o build/kernel/handlera.o -D__TARGET_RPI3__
aarch64-linux-gnu-gcc -c src/kernel/mmu.S -o build/kernel/mmu.o -D__TARGET_RPI3__

echo "[DEBUG] Compiling Kernel"
# Compile main.c uart.c print.c debug.c handler.c memory.c file.c process.c syscall.c
aarch64-linux-gnu-gcc -std=c99 -ffreestanding -mgeneral-regs-only -c src/kernel/main.c -o build/kernel/main.o -D__TARGET_RPI3__
aarch64-linux-gnu-gcc -std=c99 -ffreestanding -mgeneral-regs-only -c src/kernel/uart.c -o build/kernel/uart.o -D__TARGET_RPI3__
aarch64-linux-gnu-gcc -std=c99 -ffreestanding -mgeneral-regs-only -c src/kernel/print.c -o build/kernel/print.o -D__TARGET_RPI3__
aarch64-linux-gnu-gcc -std=c99 -ffreestanding -mgeneral-regs-only -c src/kernel/debug.c -o build/kernel/debug.o -D__TARGET_RPI3__
aarch64-linux-gnu-gcc -std=c99 -ffreestanding -mgeneral-regs-only -c src/kernel/handler.c -o build/kernel/handler.o -D__TARGET_RPI3__
aarch64-linux-gnu-gcc -std=c99 -ffreestanding -mgeneral-regs-only -c src/kernel/memory.c -o build/kernel/memory.o -D__TARGET_RPI3__
aarch64-linux-gnu-gcc -std=c99 -ffreestanding -mgeneral-regs-only -c src/kernel/file.c -o build/kernel/file.o -D__TARGET_RPI3__
aarch64-linux-gnu-gcc -std=c99 -ffreestanding -mgeneral-regs-only -c src/kernel/process.c -o build/kernel/process.o -D__TARGET_RPI3__
aarch64-linux-gnu-gcc -std=c99 -ffreestanding -mgeneral-regs-only -c src/kernel/syscall.c -o build/kernel/syscall.o -D__TARGET_RPI3__
aarch64-linux-gnu-gcc -std=c99 -ffreestanding -mgeneral-regs-only -c src/kernel/lib.c -o build/kernel/lib.o -D__TARGET_RPI3__
aarch64-linux-gnu-gcc -std=c99 -ffreestanding -mgeneral-regs-only -c src/kernel/keyboard.c -o build/kernel/keyboard.o -D__TARGET_RPI3__
